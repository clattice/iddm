...
public class IddmResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public IddmBearerTokenExtractor iddmBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new IddmBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new IddmCustomOpaqueTokenIntrospector(authorizationService);
	}
