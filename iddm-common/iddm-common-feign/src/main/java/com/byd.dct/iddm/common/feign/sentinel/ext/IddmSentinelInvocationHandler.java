 ...
 */
@Slf4j
public class IddmSentinelInvocationHandler implements InvocationHandler {
	...
	IddmSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			IddmSentinelInvocationHandler other = (IddmSentinelInvocationHandler) obj;
