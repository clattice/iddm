...
package com.byd.dct.iddm.common.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class IddmSentinelFeign {

	private IddmSentinelFeign() {

	}

	public static IddmSentinelFeign.Builder builder() {
		return new IddmSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public IddmSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new IddmSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new IddmSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new IddmSentinelInvocationHandler(target, dispatch);
				}
