package com.byd.dct.iddm.common.job;

import com.byd.dct.iddm.common.job.properties.XxlExecutorProperties;
import com.byd.dct.iddm.common.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://iddm-xxl:9080/xxl-job-admin"
