...
package com.byd.dct.iddm.common.log.event;
...
import com.byd.dct.iddm.common.core.jackson.IddmJavaTimeModule;
...
public class SysLogListener implements InitializingBean {
	...
	private final IddmLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new IddmJavaTimeModule());
	}
